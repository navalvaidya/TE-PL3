...
S : if1 rb1 CONDITION rb2 cb1 STATEMENT cb2 else1 UNDER_ELSE  {printf("\n valid syntax !!\n\n");exit(0);}

UNDER_ELSE:cb1 STATEMENT cb2

CONDITION:var less num |var less var| var gt num |var gt var| var less equ num|var less equ var | var gt equ num|var gt equ var|true1|false1|var equ_equ var|var equ_equ num;
